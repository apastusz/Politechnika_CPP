...
Exchange_Acc::Exchange_Acc(string c_na, string c_nr, string c_wa, string c_ka, float c_opr,
...
void Exchange_Acc::set_Nazwa_rachunku(string c_na) { Nazwa_rachunku = c_na; }
string Exchange_Acc::get_Nazwa_rachunku() { return Nazwa_rachunku; }


void Exchange_Acc::load_eacc() {
